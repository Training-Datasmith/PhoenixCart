...
class Paginator
{
    ...
    public function __construct(array &$table_definition)
    {
    ...
    public function display_count(): string
    {
        ...
        return sprintf(
            $this->table_definition['count_text'],
            $from,
            $to,
            $this->row_count
        );
    ...
    public function process_default(array &$row): void
    {
    ...
    public function set_current_page_number($page_number): void
    {
