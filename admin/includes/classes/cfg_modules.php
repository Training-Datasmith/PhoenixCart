...
class cfg_modules
{
    ...
    public function fix_installed_constant($type, $installed_modules): void
    {
    ...
    public static function list_modules(string $type)
    {
        ...
        if (!is_callable($generator)) {
            $generator = static::generate_modules(...);
        }
    ...
    public static function update_configuration($value, $key): void
    {
...
EOSQL
    ...
    public static function can($module, $action)
    {
        ...
        switch ($action) {
            case 'install':
                $requirements = $module::class . '::REQUIRES';
            ...
            case 'remove':
                $provides = $module::class . '::PROVIDES';
                if (!defined($provides)) {
                    return true;
                }
                ...
                return !$GLOBALS['customer_data']->has_requirements($provides, $module::class);
            default:
                return true;
        }
    }
