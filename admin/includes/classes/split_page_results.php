...
class splitPageResults
{
    ...
    public function __construct(&$current_page_number, string $max_rows_per_page, string &$sql_query, &$query_num_rows)
    {
    ...
    public function display_links($query_numrows, $max_rows_per_page, $max_page_links, $current_page_number, $parameters = [], $page_name = 'page'): string
    {
        ...
        if ($num_pages > 1) {
            ...
            foreach ($parameters as $key => $value) {
                $form->hide(rawurldecode((string) $key), rawurldecode((string) $value));
            }
