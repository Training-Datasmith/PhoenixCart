...
$table_definition = [
  'columns' => [
    [
      ...
      'function' => fn ($row) => '<a href="' . $row['onclick'] . '"><i class="fas fa-folder text-warning"></i></a>&nbsp;' . $row['geo_zone_name'],
    ],
    [
      'name' => TABLE_HEADING_ACTION,
      'class' => 'text-end',
      'function' => fn ($row) => (isset($row['info']->geo_zone_id) && ($row['info']->geo_zone_id === $row['geo_zone_id']))
