...
$table_definition = [
  'columns' => [
    ...
    [
      ...
      'function' => fn ($row) => '<a target="_blank" class="stretched-link" href="' . $row['link'] . '">' . $row['products_name'] . '</a>',
      ],
    [
      'name' => TABLE_HEADING_PURCHASED,
      'class' => 'text-end',
      'function' => fn ($row) => $row['products_ordered'],
      ],
  ],
...
$table_definition['function'] = function (array &$row) use ($link): void {
