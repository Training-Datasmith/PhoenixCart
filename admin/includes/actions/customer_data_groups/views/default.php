...
$table_definition = [
  'columns' => [
    [
      ...
      'is_heading' => true,
      'function' => fn ($row) => $row['customer_data_groups_name'],
    ],
    [
      'name' => TABLE_HEADING_SORT_ORDER,
      'function' => fn ($row) => $row['cdg_vertical_sort_order'],
    ],
    [
      'name' => TABLE_HEADING_WIDTH,
      'function' => fn ($row) => $row['customer_data_groups_width'],
    ],
    [
      'name' => TABLE_HEADING_ACTION,
      'class' => 'text-end',
      'function' => fn ($row) => (isset($row['info']->customer_data_groups_id) && ($row['customer_data_groups_id'] == $row['info']->customer_data_groups_id))
