...
$table_definition = [
  'columns' => [
    [
      ...
      'is_heading' => true,
      'function' => fn ($row) => (DEFAULT_ORDERS_STATUS_ID == $row['orders_status_id'])
    ...
    [
      ...
      'class' => 'text-center',
      'function' => fn ($row) => ($row['public_flag'] == '1')
    ...
    [
      ...
      'class' => 'text-center',
      'function' => fn ($row) => ($row['downloads_flag'] == '1')
           ? '<i class="fas fa-check-circle text-success"></i>'
           : '<i class="fas fa-times-circle text-danger"></i>',
    ],
    [
      ...
      'class' => 'text-end',
      'function' => fn ($row) => (isset($row['info']->orders_status_id) && ($row['orders_status_id'] == $row['info']->orders_status_id))
