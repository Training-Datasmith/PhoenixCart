...
$table_definition = [
  'columns' => [
    ...
    [
      ...
      'function' => fn ($row) => $Admin->catalog_image("includes/languages/{$row['directory']}/images/{$row['image']}"),
    ],
    [
      'name' => TABLE_HEADING_ACTION,
      'class' => 'text-end',
      'function' => fn ($row) => (isset($row['info']->languages_id) && ($row['languages_id'] == $row['info']->languages_id))
