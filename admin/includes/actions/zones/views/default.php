...
$table_definition = [
  'columns' => [
    ...
    [
      ...
      'function' => fn ($row) => $row['zone_name'],
    ],
    [
      'name' => TABLE_HEADING_ZONE_CODE,
      'class' => 'text-end',
      'function' => fn ($row) => $row['zone_code'],
    ],
    [
      'name' => TABLE_HEADING_ACTION,
      'class' => 'text-end',
      'function' => fn ($row) => (isset($table_definition['info']->zone_id) && ($row['zone_id'] == $table_definition['info']->zone_id))
