...
$db->query('UPDATE testimonials SET customers_id = ' . $customers_id . ", customers_name  = '" . $db->escape($customers_name) . "', testimonials_status = '" . $db->escape($testimonials_status) . "', last_modified = NOW() WHERE testimonials_id = " . (int)$testimonials_id);
