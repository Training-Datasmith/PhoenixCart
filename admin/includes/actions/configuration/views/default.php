...
$table_definition = [
  'columns' => [
    [
      ...
      'is_heading' => true,
      'function' => fn ($row) => $row['configuration_title'],
    ],
    [
      ...
      'function' => function (array $row): string {
          ...
          return htmlspecialchars((string) $cfg_value);
      },
    ],
    [
      'name' => TABLE_HEADING_ACTION,
      'class' => 'text-end',
      'function' => fn ($row) => (isset($row['info']->configuration_id) && ($row['configuration_id'] == $row['info']->configuration_id))
