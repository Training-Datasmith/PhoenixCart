...
$table_definition = [
  'columns' => [
    [
      ...
      'function' => fn ($row) => $row['products_name'],
    ],
    [
      'name' => TABLE_HEADING_RATING,
      'function' => fn ($row) => new star_rating((float)$row['reviews_rating']),
    ],
    [
    ...
    [
      ...
      'class' => 'text-end',
      'function' => fn ($row) => (isset($row['info']->reviews_id) && ($row['info']->reviews_id === $row['reviews_id']))
