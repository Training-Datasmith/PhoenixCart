...
{
    public const CONFIG_KEY_BASE = 'MODULE_ADMIN_DASHBOARD_ADMIN_LOGINS_';
...
EOSQL
        ...
        while ($logins = $logins_query->fetch_assoc()) {
            ...
            $output .= '<td>'
                     ...
                     . ' <a href="' . $GLOBALS['Admin']->link('action_recorder.php', 'module=ar_admin_login&aID=' . (int)$logins['id']) . '">' . htmlspecialchars((string) $logins['user_name']) . '</a></td>';
