...
{
    public const CODE = 'dashboard';
    public const DIRECTORY = DIR_FS_ADMIN . 'includes/modules/dashboard/';
    public const LANGUAGE_DIRECTORY = DIR_FS_ADMIN . 'includes/languages/';
    public const KEY = 'MODULE_ADMIN_DASHBOARD_INSTALLED';
    public const TITLE = MODULE_CFG_MODULE_DASHBOARD_TITLE;
    public const TEMPLATE_INTEGRATION = false;

    public const GET_HELP_LINK = 'https://phoenixcart.org/phoenixcartwiki/index.php?title=Dashboard';
