...
{
    public const CODE = 'navbar';
    public const DIRECTORY = DIR_FS_CATALOG . 'includes/modules/navbar/';
    public const LANGUAGE_DIRECTORY = DIR_FS_CATALOG . 'includes/languages/';
    public const KEY = 'MODULE_CONTENT_NAVBAR_INSTALLED';
    public const TITLE = MODULE_CFG_MODULE_CONTENT_NAVBAR_TITLE;
    public const TEMPLATE_INTEGRATION = false;

    public const GET_HELP_LINK = 'https://phoenixcart.org/phoenixcartwiki/index.php?title=Navbar_Modules';
