...
//--></script>';
        ...
        return $choose_audience_string . '</form>';
    }
    ...
    public function confirm(): string
    {
        ...
        return $confirm_string . $GLOBALS['Admin']->button(IMAGE_CANCEL, 'fas fa-angle-left', 'btn-light mt-1', $link->set_parameter('action', 'send'));
    }
