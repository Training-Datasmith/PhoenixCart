...
*
*/
class Hook_admin_orders_delete_Stripe_Orders
{
    public function listen_inject_site_start(): void
    {
        global $db;
        if (defined('MODULE_PAYMENT_STRIPE_SCA_STATUS') && MODULE_PAYMENT_STRIPE_SCA_STATUS == 'True' && !empty(MODULE_PAYMENT_STRIPE_SCA_DAYS_DELETE) && !isset($_SESSION['stripe_orders_deleted'])) {
            $this->load_lang();
            ...
            EOSQL, (int) MODULE_PAYMENT_STRIPE_SCA_PREPARE_ORDER_STATUS_ID, MODULE_PAYMENT_STRIPE_SCA_TEXT_PUBLIC_TITLE, MODULE_PAYMENT_STRIPE_SCA_DAYS_DELETE));
