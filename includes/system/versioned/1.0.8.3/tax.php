...
class Tax
{
    ...
    public static function calculate($price, $tax): int|float
    {
        return $price * $tax / 100;
    }

    public static function fetch($class_id, $country_id, $zone_id): array
    {
...
EOSQL
     ...
     * @param numeric $value
     */
    public static function format($value, int $padding = TAX_DECIMAL_PLACES): string
    {
