...
EOSQL
    ...
    public static function update_session_id($old_id, $new_id = null): void
    {
        global $db;
...
EOSQL
        ...
        $db->query("DELETE FROM whos_online WHERE session_id = '" . $db->escape($old_id) . "' OR time_last_click < " . time() - 900);
    }
