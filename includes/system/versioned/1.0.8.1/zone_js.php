...
class zone_js implements \Stringable
{
    protected string $prefix;

    public function __construct(protected $country, $form, $field)
    {
    ...
    public function __toString(): string
    {
        ...
        return $output_string . ('  } else {' . PHP_EOL . $this->prefix . '0] = new Option("' . TYPE_BELOW . '", "");' . PHP_EOL . '  }' . PHP_EOL);
    }
