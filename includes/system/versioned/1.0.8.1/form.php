...
class Form extends named_html_element implements \Stringable
{
    protected $stash = [];
    protected $tokenize;
    ...
    public function hide(string $name, string $value): static
    {
     ...
     */
    public function hide_session_id(): static
    {
    ...
    public static function validate_action_is($action = 'process')
    {
        ...
        if (is_null($requested_action)
         || is_null($formid)
         || (strlen((string) $formid) !== strlen((string) $_SESSION['sessiontoken']))) {
            return false;
        }
     ...
     */
    public static function block_processing(): void
    {
        $GLOBALS['error'] = true;
    }
    ...
    public static function reset_session_token(): void
    {
