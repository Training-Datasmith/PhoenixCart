...
class Image extends html_element implements \Stringable
{
     ...
     */
    public function set_default($default): static
    {
     ...
     */
    public function set_responsive(bool $responsive): static
    {
     ...
     */
    public function set_web_prefix($prefix): static
    {
     ...
     */
    public function normalize_paths(): static
    {
