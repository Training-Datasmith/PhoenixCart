...
class info_pages
{
    ...
    */
    ...
    public static function split_page_results(): \splitPageResults
    {
        ...
        return new splitPageResults($_GET['page'], MAX_DISPLAY_SEARCH_RESULTS, $pages_query_raw, $pages_query_numrows);
    }
