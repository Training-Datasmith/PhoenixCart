...
class info_pages
{
    ...
    */
    public static function get_container($container = [], $order_by = 'p.sort_order')
    {
    ...
    */
    public static function get_element($container = [], $element = null)
    {
    ...
    {
        $page_arr = info_pages::get_container($arr);
    ...
    public static function split_page_results(): \Split_Page_Results
    {
        ...
        return new Split_Page_Results($_GET['page'], MAX_DISPLAY_SEARCH_RESULTS, $pages_query_raw, $pages_query_numrows);
    }
    public static function requirements($required_slugs = ['conditions', 'privacy', 'shipping', 'ssl_check', 'cookie_usage']): array
    {
        return array_diff($required_slugs, array_column($GLOBALS['db']->fetch_all('SELECT slug FROM pages ORDER BY slug'), 'slug'));
    }
}