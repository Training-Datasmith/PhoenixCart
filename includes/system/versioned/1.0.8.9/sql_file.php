...
class sql_file
{
    ...
    public function __construct(protected $filename, $directory, $alias = null)
    {
    ...
    public function run_sql_or_die($sql): void
    {
        $this->run_sql($sql);
    ...
    public static function message($message, $type = 'error'): void
    {
        error_log($message);
    ...
    public function validate_packet($filesize): bool
    {
    ...
    public function validate_size($file): bool
    {
