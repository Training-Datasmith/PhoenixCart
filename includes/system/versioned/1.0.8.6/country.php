...
class Country
{
    ...
    public static function fetch($country_id): array
    {
    ...
    public static function draw_menu($name, string $selected = '', $parameters = [], $default = PULL_DOWN_DEFAULT)
    {
    ...
    public static function match_classification($classification, $country_id)
    {
        return match ($classification) {
            'national' => STORE_COUNTRY == $country_id,
            'international' => STORE_COUNTRY != $country_id,
            'both' => true,
            default => false,
        };
    }

    public static function fetch_id_from_iso(string $iso)
    {
