...
class query
{
    ...
    public static function rtrim_string_once(string $haystack, string $needle)
    {
    ...
    public static function build_columns(array $db_tables): string
    {
        $sql = '';
    ...
    private static function _build_criteria($alias, $column_values): string
    {
        $sql = '';
