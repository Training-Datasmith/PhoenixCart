...
class customer_query extends query
{
    ...
    public static function build_joins(array $db_tables, array $criteria): string
    {
        $sql = '';
    ...
    public static function build_read($db_tables, $criteria): string
    {
        ...
        return $sql . self::build_where($criteria);
    }
