...
{
    public const INTERVAL = 'P10D';

    public static function execute(): void
    {
        if ('create_account_success.php' === basename((string) Request::get_page())) {
    ...
    public static function admin_add($customer_id, string $send_at, $language_id): void
    {
