...
{
    public const CONFIG_KEY_BASE = 'MODULE_CUSTOMER_DATA_COUNTRY_';

    public const PROVIDES = [
      'country',
      'country_id',
      'entry_country_id',
      'country_name',
    ...
    public function get($field, array &$customer_details)
    {
        ...
        switch ($field) {
            ...
            case 'country':
                ...
                if (isset($customer_details['country']['id']) && 6 > count(array_filter($customer_details['country'], fn ($v) => isset($v)))) {
    ...
    public function display_input($customer_details = null): void
    {
    ...
    public function process(array &$customer_details): bool
    {
    ...
    public function draw_country_list($name, $parameters = []): \Select
    {
