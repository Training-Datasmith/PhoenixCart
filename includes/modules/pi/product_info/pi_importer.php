    ...
    public function get_output(): void
    {
        if (isset($GLOBALS['product']) && $GLOBALS['product'] instanceof Product) {
            ...
            if ($pim_importer->_data) {
                $_name = $pim_importer->get_data('importers_name');
                $_image = $pim_importer->get_data('importers_image');
