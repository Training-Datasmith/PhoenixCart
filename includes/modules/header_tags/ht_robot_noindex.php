...
{
    public const CONFIG_KEY_BASE = 'MODULE_HEADER_TAGS_ROBOT_NOINDEX_';
    ...
    public function execute(): void
    {
        if (!Text::is_empty(MODULE_HEADER_TAGS_ROBOT_NOINDEX_PAGES)) {
            if (in_array(basename((string) Request::get_page()), page_selection::_get_pages($this->base_constant('PAGES')))) {
