...
{
    public const CONFIG_KEY_BASE = 'MODULE_CONTENT_GDPR_PERSONAL_DETAILS_';
    ...
    public function execute(): void
    {
        ...
        $gdpr_gender = match ($customer->get('gender')) {
            'm' => MODULE_CONTENT_GDPR_PERSONAL_DETAILS_GENDER_M,
            'f' => MODULE_CONTENT_GDPR_PERSONAL_DETAILS_GENDER_F,
            default => MODULE_CONTENT_GDPR_PERSONAL_DETAILS_UNKNOWN,
        };
