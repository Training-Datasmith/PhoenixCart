...
{
    public const CONFIG_KEY_BASE = 'MODULE_CONTENT_ACCOUNT_STRIPE_SCA_CARDS_';
    /**
     * @var 'Stripe SCA Cards Management Page'
     */
    public $public_title = '';
    ...
    public function __construct()
    {
        ...
        if (defined('MODULE_PAYMENT_INSTALLED')
          ...
          && in_array('stripe_sca.php', explode(';', (string) MODULE_PAYMENT_INSTALLED))) {
