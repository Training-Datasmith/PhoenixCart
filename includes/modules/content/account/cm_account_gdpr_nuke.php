...
{
    public const CONFIG_KEY_BASE = 'MODULE_CONTENT_ACCOUNT_GDPR_NUKE_';
    ...
    public static function show_countries($text): string
    {
        return Text::is_empty($text)
             ? ''
             : nl2br(implode("\n", array_map(Country::fetch_name(...), explode(';', (string) $text))));
    }
