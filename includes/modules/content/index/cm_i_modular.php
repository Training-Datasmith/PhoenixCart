...
class cm_i_modular extends abstract_executable_module
{
    ...
    public function execute(): void
    {
        ...
        if (defined('MODULE_CONTENT_I_INSTALLED') && !Text::is_empty(MODULE_CONTENT_I_INSTALLED)) {
            $i_modules = array_filter(array_map(function ($im) {
                ...
                return new $class();
            }, explode(';', (string) MODULE_CONTENT_I_INSTALLED)), fn ($_i) => $_i->isEnabled());
    ...
    public static function display_layout()
    {
        ...
        $slots = [
          'A' => ['width' => MODULE_CONTENT_I_MODULAR_A_WIDTH],
          'B' => ['width' => MODULE_CONTENT_I_MODULAR_B_WIDTH],
          'C' => ['width' => MODULE_CONTENT_I_MODULAR_C_WIDTH],
          'D' => ['width' => MODULE_CONTENT_I_MODULAR_D_WIDTH],
          'E' => ['width' => MODULE_CONTENT_I_MODULAR_E_WIDTH],
          'F' => ['width' => MODULE_CONTENT_I_MODULAR_F_WIDTH],
          'G' => ['width' => MODULE_CONTENT_I_MODULAR_G_WIDTH,],
          'H' => ['width' => MODULE_CONTENT_I_MODULAR_H_WIDTH],
