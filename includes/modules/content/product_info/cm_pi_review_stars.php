...
{
    public const CONFIG_KEY_BASE = 'MODULE_CONTENT_PI_REVIEW_STARS_';
    ...
    public function execute(): void
    {
        ...
        if ($review_count > 0) {
            ...
            if (1 === $review_count) {
                $review_ratings[] = sprintf(MODULE_CONTENT_PI_REVIEW_STARS_COUNT_ONE, $review_count);
            } else {
                $review_ratings[] = sprintf(MODULE_CONTENT_PI_REVIEW_STARS_COUNT, $review_count);
            }
