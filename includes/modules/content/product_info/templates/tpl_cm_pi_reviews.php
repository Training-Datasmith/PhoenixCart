<div class="<?= MODULE_CONTENT_PRODUCT_INFO_REVIEWS_CONTENT_WIDTH ?> cm-pi-reviews">
  ...
  <div class="row">
    ...
    while ($review = $review_query->fetch_assoc()) {
        ...
        echo htmlspecialchars((string) $review['reviews_text']);
        echo '</blockquote>';
        echo '<figcaption class="blockquote-footer">';
        echo sprintf(MODULE_CONTENT_PRODUCT_INFO_REVIEWS_TEXT_RATED, new star_rating((float)$review['reviews_rating']), htmlspecialchars((string) $review['customers_name']));
        echo'</figcaption>';
        echo '</figure>';
        echo '</div>';
    }
