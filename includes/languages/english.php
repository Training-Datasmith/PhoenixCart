...
$long_date_formatter = new Intl_Date_Formatter('en', Intl_Date_Formatter::FULL, Intl_Date_Formatter::NONE);
$short_date_formatter = new Intl_Date_Formatter('en', Intl_Date_Formatter::SHORT, Intl_Date_Formatter::NONE);
$date_time_formatter = new Intl_Date_Formatter('en', Intl_Date_Formatter::SHORT, Intl_Date_Formatter::LONG);
