...
const MY_ORDERS_VIEW = 'View orders';

const EMAIL_NOTIFICATIONS_TITLE = 'Notifications';
const EMAIL_NOTIFICATIONS_NEWSLETTERS = 'Newsletters';
const EMAIL_NOTIFICATIONS_PRODUCTS = 'Product notifications';
