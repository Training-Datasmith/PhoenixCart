...
const I_HERO_DESCRIPTION = 'Display Text in a Hero Layout.<div class="alert alert-info">This is a child module for use with the &pi; system.</div>';

const I_HERO_TEXT = <<<EOT
<h1 class="text-body-emphasis">#yourphoenix #yourcommunity</h1>
<p class="col-lg-8 mx-auto fs-5 text-muted">
  Snap it, Tag it, Share it.  Make it yours.
</p>
EOT;
