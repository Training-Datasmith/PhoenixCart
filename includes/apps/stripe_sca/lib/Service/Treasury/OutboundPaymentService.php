...
class Outbound_Payment_Service extends \Stripe\Service\Abstract_Service
{
    ...
    {
        return $this->request_collection('get', '/v1/treasury/outbound_payments', $params, $opts);
    }
    /**
    ...
    {
        return $this->request('post', $this->build_path('/v1/treasury/outbound_payments/%s/cancel', $id), $params, $opts);
    }
    /**
    ...
    {
        return $this->request('get', $this->build_path('/v1/treasury/outbound_payments/%s', $id), $params, $opts);
    }
}