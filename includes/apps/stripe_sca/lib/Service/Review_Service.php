...
class Review_Service extends \Stripe\Service\Abstract_Service
{
    /**
    ...
    {
        return $this->request_collection('get', '/v1/reviews', $params, $opts);
    }
    /**
    ...
    {
        return $this->request('post', $this->build_path('/v1/reviews/%s/approve', $id), $params, $opts);
    }
    /**
    ...
    {
        return $this->request('get', $this->build_path('/v1/reviews/%s', $id), $params, $opts);
    }
}