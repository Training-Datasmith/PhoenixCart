...
class Promotion_Code_Service extends \Stripe\Service\Abstract_Service
{
    /**
    ...
    {
        return $this->request_collection('get', '/v1/promotion_codes', $params, $opts);
    }
    /**
    ...
    {
        return $this->request('get', $this->build_path('/v1/promotion_codes/%s', $id), $params, $opts);
    }
    /**
    ...
    {
        return $this->request('post', $this->build_path('/v1/promotion_codes/%s', $id), $params, $opts);
    }
}