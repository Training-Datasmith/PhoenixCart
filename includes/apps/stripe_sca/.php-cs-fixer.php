...
$finder = Php_Cs_Fixer\Finder::create()->in(__DIR__)->not_path('tests/TestCase.php');
$config = new Php_Cs_Fixer\Config();
$config->set_risky_allowed(true);
$config->set_rules([
    // Rulesets
    '@PSR2' => true,
    '@PhpCsFixer' => true,
