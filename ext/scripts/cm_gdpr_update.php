...
EOSQL
            ...
            case 'ip':
                ...
                $db->query("UPDATE action_recorder SET identifier = '::anonymized::' WHERE identifier = '" . $db->escape($flag) . "' AND user_id = " . $cID);
                break;
            case 'cookies':
                $_cookie_sess = $_POST['cookie'];

                setcookie($_cookie_sess, '', ['expires' => time() - 86400, 'path' => '/']);
