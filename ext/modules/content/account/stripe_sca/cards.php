...
if (defined('MODULE_PAYMENT_INSTALLED') && !Text::is_empty(MODULE_PAYMENT_INSTALLED) && in_array('stripe_sca.php', explode(';', (string) MODULE_PAYMENT_INSTALLED))) {
...
EOSQL
        ...
        if ($token = $token_query->fetch_assoc()) {
            ...
            [$customer, $card] = explode(':|:', (string) $token['stripe_token'], 2);
