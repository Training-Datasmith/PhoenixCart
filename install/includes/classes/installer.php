...
class Installer
{
    public static function burn($path, $contents): void
    {
    ...
    public static function configure($key, $value): void
    {
        global $db;
     ...
     * @return list<string>
     */
    public static function find_unwritable_files($directory): array
    {
    ...
    public static function load_sql($db, string $sql_file)
    {
    ...
    public static function load_time_zones(): array
    {
        return array_map(fn (string $v) => ['id' => $v, 'text' => str_replace('_', ' ', $v)], timezone_identifiers_list());
    }
