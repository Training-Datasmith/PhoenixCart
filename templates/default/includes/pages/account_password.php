...
$input = (new Input('password_current', ['autofocus' => 'autofocus', 'autocapitalize' => 'none', 'id' => $input_id, 'autocomplete' => 'current-password', 'placeholder' => ENTRY_PASSWORD_CURRENT_TEXT], 'password'))->require() . FORM_REQUIRED_INPUT;
