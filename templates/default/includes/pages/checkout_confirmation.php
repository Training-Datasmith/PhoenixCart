...
echo LIST_PRODUCTS . sprintf(LINK_TEXT_EDIT, 'fw-lighter ms-2', $Linker->build('shopping_cart.php'));
?></p>
...
?>
  ...
  <p class="fs-5 fw-semibold mb-1"><?php 
echo HEADING_ORDER_COMMENTS;
?></p>
  
  <div class="form-floating mb-2">
    <?php 
echo new Textarea('comments', ['style' => 'height: 120px', 'id' => 'inputComments', 'placeholder' => ENTRY_COMMENTS_PLACEHOLDER]);
?>
    <label for="inputComments"><?php 
echo ENTRY_COMMENTS;
?></label>
  </div>
