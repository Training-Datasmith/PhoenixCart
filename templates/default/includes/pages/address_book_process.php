...
if (isset($_GET['delete'])) {
  ...
  <div class="row">
    ...
    ?></div>
        ...
        <div class="card-body">
          <?php 
    echo $customer->make_address_label((int) $_GET['delete'], true, ' ', '<br>');
    ?>
        </div>
      </div>
    </div>
  ...
  <div class="d-grid">
    <?php 
    echo new Button(IMAGE_BUTTON_DELETE, 'fas fa-trash-alt', 'btn-danger btn-lg', [], $Linker->build('address_book_process.php', ['delete' => $_GET['delete'], 'action' => 'deleteconfirm', 'formid' => $_SESSION['sessiontoken']]));
    ?>
  </div>
  
  <div class="my-2">
    <?php 
    echo new Button(IMAGE_BUTTON_BACK, 'fas fa-angle-left', 'btn-light', [], $Linker->build('address_book.php'));
    ?>
  </div>
...
<?php 
  ...
  <div class="my-2">
    <?php 
    echo new Button(IMAGE_BUTTON_BACK, 'fas fa-angle-left', 'btn-light', [], $back_link);
    ?>
  </div>
