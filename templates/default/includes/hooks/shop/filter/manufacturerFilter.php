...
*/
class Hook_shop_filter_manufacturer_Filter
{
    public function listen_nav_item_filters()
    {
        ...
        if (PRODUCT_LIST_FILTER > 0) {
            if (empty($_GET['manufacturers_id'])) {
                ...
                EOSQL, (int) $GLOBALS['current_category_id']);
            } else {
                $filterlist_sql = sprintf(<<<'EOSQL'
                ...
                EOSQL, (int) $_SESSION['languages_id'], (int) $_GET['manufacturers_id']);
            }
