...
class default_template
{
    ...
    protected $_base_hook_directories = [DIR_FS_CATALOG . 'templates/default/includes/hooks/'];
    protected $_base_override_directories = [DIR_FS_CATALOG . 'templates/default/includes/override/'];
    ...
    {
        $template_file = $this->_template_mapping[$file] ?? static::_get_template_mapping_for($file, $type);
